...
class LaneRouteSystem:
    ...
    """
    def __init__(self, nav: NavigationGrid, lanes_y: list[int], player_pyr: tuple[int, int], enemy_pyr: tuple[int, int], pyramid_ids: set[int]):
        self.nav = nav
...
class GameApp:
    ...
    def _setup_match(self):
        ...
        attack_range = 1.25  # un poil + safe
