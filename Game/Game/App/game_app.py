        ...
        while self.running:
            ...
            if self.state == "menu":
                ...
                if self.menu_background:
                    ...
                    self.renderer.draw_center_overlay("Antique War", "")
                ...
                self.renderer.draw_blurred_panel(panel_x, panel_y, panel_w, panel_h, blur_radius=10)
                ...
                self.renderer.draw_blurred_panel(48, 120, self.width - 96, self.height - 190, blur_radius=10)
