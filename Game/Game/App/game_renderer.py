...
class GameRenderer:
    ...
    def draw_menu(self):
        ...
        if self.app.menu_background:
            ...
            self.draw_center_overlay("Antique War", "")
    ...
    def draw_difficulty_select(self):
        ...
        self.draw_blurred_panel(panel_x, panel_y, panel_w, panel_h, blur_radius=10)
    ...
    def draw_controls(self):
        ...
        self.draw_blurred_panel(48, 120, self.app.width - 96, self.app.height - 190, blur_radius=10)
